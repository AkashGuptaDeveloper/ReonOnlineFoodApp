class AllSubCategoryModel {
  ...
  List<AllSubCategoryData> data;

  AllSubCategoryModel({this.status, this.statusMessage, this.data});

  AllSubCategoryModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    statusMessage = json['status_message'];
    if (json['data'] != null) {
      data = new List<AllSubCategoryData>();
      json['data'].forEach((v) {
        data.add(new AllSubCategoryData.fromJson(v));
      });
    }
  }
...
class AllSubCategoryData {
  ...
  AllSubCategoryData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
