                          ...
                          builder: (BuildContext context) {
                            return GestureDetector(
                              ...
                              child:Container(
                                ...
                                child: Image.network(
                                  GlobalServiceURL.ImageURL + '${imgUrl.image}',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            );
                                  ...
                                  return new GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        ...
                                        var route = new MaterialPageRoute(
                                          builder: (BuildContext context) =>
                                          new SubCategory(
                                            SendUserID: "${_SearchList[index].id.toString()}",
                                          ),
                                        );
                                    ...
                                    child: Card(
                                        ...
                                        child: Column( children: <Widget>[
                                          Expanded(
                                            child:Container(
                                              ...
                                              child: CachedNetworkImage(
                                                imageUrl:GlobalServiceURL.ImageURL+_SearchList[index].image.toString(),
                                          ...
                                          Text(_SearchList[index].categoryName,style: TextStyle(
                                              fontFamily: GlobalFlag.FontCode.toString(),color:GlobalAppColor.AppIcon, fontSize: 15, fontWeight: FontWeight.w600
                                          ),),
                                          Text(_SearchList[index].updatedAt,style: TextStyle(
                                              fontFamily: GlobalFlag.FontCode.toString(),color:GlobalAppColor.AppIcon, fontSize: 12, fontWeight: FontWeight.w600
                                          ),),
                                          SizedBox(height: 5.0,),
                                        ],)
                                    ),
                                    ...
                                    onTap: () {
                                      setState(() {
                                        ...
                                        var route = new MaterialPageRoute(
                                          builder: (BuildContext context) =>
                                          new SubCategory(
                                            SendUserID: "${_HomeList[index].id.toString()}",
                                          ),
                                        );
                                        Navigator.of(context).push(route);
                                      });
                                        ...
                                        child: Column( children: <Widget>[
                                          Expanded(
                                            child:Container(
                                              margin: EdgeInsets.all(3.0),
                                              child: CachedNetworkImage(
                                                imageUrl:GlobalServiceURL.ImageURL+_HomeList[index].image.toString(),
                                                imageBuilder: (context, imageProvider) => Container(
                                                  decoration: BoxDecoration(
                                                    image: DecorationImage(
                                                        image: imageProvider, fit: BoxFit.cover),
                                          ...
                                          Text(_HomeList[index].categoryName,style: TextStyle(
                                              fontFamily: GlobalFlag.FontCode.toString(),color:GlobalAppColor.AppIcon, fontSize: 15, fontWeight: FontWeight.w600
                                          ),),
                                          Text(_HomeList[index].updatedAt,style: TextStyle(
                                              fontFamily: GlobalFlag.FontCode.toString(),color:GlobalAppColor.AppIcon, fontSize: 12, fontWeight: FontWeight.w600
                                          ),),
                                          SizedBox(height: 5.0,),
                                        ],)
...
//-----------------------_onBackPressed---------------------------------------//
  Future<bool> _onBackPressed() {
    return showDialog(
      ...
      builder: (context) =>
      new AlertDialog(
        title: new Text(GlobalFlag.Areyousure, style: TextStyle(color: GlobalAppColor.AppIcon,),),
        content: new Text(GlobalFlag.exitanApp, style: TextStyle(color: GlobalAppColor.AppIcon,),),
        actions: <Widget>[
          new GestureDetector(
            onTap: () => Navigator.of(context).pop(false),
            child: roundedButton(GlobalFlag.No, const Color(0xFF696969), const Color(0xFFFFFFFF)),
          ),
          new GestureDetector(
            onTap: () => exit(0),
            child: roundedButton(GlobalFlag.Yes, const Color(0xFF696969), const Color(0xFFFFFFFF)),
          ),
        ],
      ),
    ) ??
  ...
  Widget roundedButton(String buttonLabel, Color bgColor, Color textColor) {
    var loginBtn = new Container(
      ...
      decoration: new BoxDecoration(
        ...
        boxShadow: <BoxShadow>[BoxShadow(color: const Color(0xFFcff1c0), offset: Offset(1.0, 6.0), blurRadius: 0.001,),
        ],
      ),
...
//------------------------------fetchImagePost--------------------------------//
  fetchImagePost() {
    http.post(read_offersUrl_ServiceUrl, body: {
...
//------------------------------Offer-Form------------------------------------//
  void _openFormView(BuildContext context) {
...
//----------------------------------SpecialOfferText--------------------------//
                          Padding(
                            ...
                            child: Center(
                              child:Text(GlobalFlag.OfferTexr.toString(),textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,fontSize:18,color: Colors.white,decoration: TextDecoration.none),),
                            ),
                          ),
//============================Name-controller=================================//
                          Padding(
...
//-------------------------------CouponFormPost--------------------------------//
  // ignore: non_constant_identifier_names
  Future<void> CouponFormPost() async{
    try{
...
//--------------------------------_FormFailedAlert-----------------------------//
  ...
  Future<void> _FormFailedAlert() async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(GlobalFlag.WarningMessage, textAlign: TextAlign.center,
            style: new TextStyle(fontSize: 15.0, color:GlobalAppColor.AppBarColorCode, fontWeight: FontWeight.bold,fontFamily: GlobalFlag.FontCode.toString(),),),
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(GlobalFlag.oncemore.toString(),textAlign: TextAlign.center, style: new TextStyle(fontSize: 15.0, color:GlobalAppColor.AppBarColorCode, fontWeight: FontWeight.bold,fontFamily: GlobalFlag.FontCode.toString(),),),
              ],
            ),
          ),
          actions: <Widget>[
            FlatButton(
              ...
              child: Text(GlobalFlag.TryAgain.toString(), style: new TextStyle(fontSize: 15.0, color:GlobalAppColor.AppBarColorCode, fontWeight: FontWeight.bold,fontFamily: GlobalFlag.FontCode.toString(),),),
            ),
          ],
        );
      },
