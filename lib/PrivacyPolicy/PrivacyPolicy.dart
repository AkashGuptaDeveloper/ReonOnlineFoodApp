...
class PrivacyPolicy extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagPrivacyPolicy.toString();
  @override
...
//----------------------------------------ServiceUrl--------------------------//
  ...
  String PrivacyPolicyUrl_ServiceUrl=GlobalServiceURL.PrivacyPolicyUrl.toString();
//----------------------------------------Global-Variable----------------------//
...
//----------------------------------FetchTermsConditionScreenFromServer-------//
  ...
  Future<void> FetchTermsConditionScreenFromServer() async {
    // ignore: non_constant_identifier_names
    try{
      http.post(PrivacyPolicyUrl_ServiceUrl.toString(), body: {
        // ignore: non_constant_identifier_names
      }).then((resultHomeList) {
